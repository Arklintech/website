...
export const SYSTEMS_OVERVIEW = {
  ...
  narrative: 'We bring the systems running the business together—integrating software, data pipelines, operational rules, and executive workflows so the organization can operate as one.',
...
export const SYSTEM_LAYERS: SystemLayer[] = [
  {
    ...
    positioning: 'Transform raw operational information into actionable intelligence and real-time decisions.',
  ...
  },
  {
    ...
    description: 'Containerized microservice clusters, automated failover networks, and edge data routing engineered for dependable, zero-downtime execution.',
