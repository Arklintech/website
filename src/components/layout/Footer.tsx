        ...
        <div className="relative z-10">
          ...
          <div className="pt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-mono text-xs text-[#768494]">
            ...
            <div className="flex items-center gap-4 text-[#768494]">
              ...
              <span>•</span>
              <Link href="/trust-security" className="hover:text-[#536070] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#1677FF] rounded">Cookies</Link>
            </div>
          </div>
        </div>
      </div>
