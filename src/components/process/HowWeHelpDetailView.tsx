...
import { HowWeHelpItem } from '@/content/howWeHelp';
import { ArrowLeft, ArrowRight, Box, Cog, Cpu, RefreshCw, Disc, Sparkles } from 'lucide-react';

interface HowWeHelpDetailViewProps {
  item: HowWeHelpItem;
}

export default function HowWeHelpDetailView({ item }: HowWeHelpDetailViewProps) {
