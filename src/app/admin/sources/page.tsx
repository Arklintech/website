    ...
    <div className="p-3.5 sm:p-6 max-w-[1200px] mx-auto space-y-5 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs sm:text-sm text-[#64748B] mt-0.5">Channel performance, visitor volume, and inbound acquisition from Google Sheets & telemetry.</p>
        </div>
        <button
          onClick={loadSources}
                  ...
                  <tr key={src.source} className="hover:bg-[#FDFBF7] transition-colors">
                    <td className="px-4 py-3.5">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-lg bg-[#EDF4FF] border border-[#1463FF]/15 flex items-center justify-center shrink-0">
                          <Globe className="w-4 h-4 text-[#1463FF]" />
                        </div>
                        <span className="font-semibold text-xs text-[#0B132B] truncate">{src.source}</span>
                      </div>
                    </td>
                    <td className="px-4 py-3.5 font-mono text-xs font-bold text-[#0B132B] whitespace-nowrap">{src.visits}</td>
                    <td className="px-4 py-3.5 font-mono text-xs font-bold text-[#1463FF] whitespace-nowrap">{src.pct}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
